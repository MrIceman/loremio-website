                        ...
                        <div class="feature-wrap icons">
                            <div class="feature-content icons">
                                <img
                                    ...
                                    width="80" alt="" class="feature-icon"/>
                                <h4 class="black-text">Kundenbeziehung</h4>
                                <p class="paragraph-10">Deine Angebote erreichen innerhalb Sekunden nicht nur deine
                            ...
                            <div class="feature-content icons">
                                <img
                                    ...
                                    width="74" alt="" class="feature-icon"/>
                                <h4 class="black-text">Absatz- und Werbekanal</h4>
                                <p class="paragraph-9">Du erhältst einen exklusiven Werbekanal - die Taschen deiner
                            ...
                            <div class="feature-content icons">
                                ...
                                <p class="paragraph-8">Ihnen wird nicht nur für Ihr Unternehmen eine digitale Präsenz
